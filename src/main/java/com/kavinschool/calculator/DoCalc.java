...
public class DoCalc implements Calculator{
    @Override
    ...
    private void evaluate(Deque<String> operators, Deque<Double> numbers) throws CalculatorException {
    ...
    private double getResult(String op, double second, double first) throws CalculatorException {
        double result;
        switch (op) {
            case "+":
                result = first + second;
